...
class mapa_seguimiento extends StatefulWidget {
  ...
  mapa_seguimiento(this.fromPoint,this.toPoint,this.id);


  @override
  _mapa_seguimientoState createState() => _mapa_seguimientoState();



}

class _mapa_seguimientoState extends State<mapa_seguimiento> {
